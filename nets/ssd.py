...
from nets.mobilenetv3 import MobileNetBase, MobileNetV3_Large, MobileNetV3_Small
...
def SSD300(input_shape, num_classes=21):
    ...
    mbn3L_model = MobileNetV3_Small(shape=input_shape, n_class=num_classes, include_top=False, backbone=True, input_tensor=input_tensor).build(plot=False)
    # SSD结构,net字典
    ...
    # 将所有结果进行堆叠
    net['mbox_loc'] = concatenate([net['conv4_3_loc_flat'],
    ...
    net['mbox_conf'] = concatenate([net['conv4_3_conf_flat'],
    ...
    net['mbox_priorbox'] = concatenate([net['conv4_3_priorbox'],
